...
1. Download the median age by state tables for 2010 and 2020 from the Canvas assignment [here](). You can use the `read_csv` function from the `readr` package to open these files and save them as `age_2010` and `age_2020`.
