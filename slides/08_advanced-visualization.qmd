...
Today we'll start using the [The Humane League's US Egg Production
dataset](https://thehumaneleague.org/article/E008R01-us-egg-production-data), which we can load using the following code:
