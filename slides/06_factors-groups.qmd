---
title: "MATH167R: Descriptive statistics"
author: "Peter Gao"
format: 
  revealjs:
...
color_fct_1 <- factor(color_var, levels = color_var)
```
...
## `fct_drop()`: drop unused levels or add levels
