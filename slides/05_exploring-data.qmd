...
This can be done in the opening code chunk. If it is a `.Rmd`, you can set the parameter
`include = FALSE` to hide the messages and code if the details are unimportant for the reader.
