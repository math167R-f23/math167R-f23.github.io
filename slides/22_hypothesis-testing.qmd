...
This is our **test statistic**, a statistic calculated from our sample data which we will use to evaluate our hypotheses.
...
![(Devore)](images/Screenshot 2023-10-28 at 10.30.53 AM.png)
...
Conducting t-tests in R is very easy using the function `t.test()`. 
