...
1. Choose a data set or multiple datasets with the following characteristics:
    ...
    b. At least three categorical variables
2. Identify three research questions of interest that you want to study using this dataset.
3. For each of your three research questions, generate a data visualization or descriptive statistic. Discuss and interpret your findings. 
4. For at least one of your research questions, perform a statistical analysis (ex. linear regression or hypothesis test). Discuss and interpret your findings. 
...
* A brief description of your dataset (where it is from, how it can be obtained, what variables are included).
...
## Part Two: Final Report (70 points), due 12/6
...
* **Introduction and background**: Introduce your dataset and research questions of interest. Discuss any previous research/findings or relevant context on your question of interest.
* **Exploratory data analysis**: For each of your three research questions, generate a data visualization or descriptive statistic. Discuss and interpret your findings. 
* **Inferential statistical analysis**: For at least one of your research questions, perform a statistical analysis (ex. linear regression or hypothesis test). Discuss and interpret your findings.
* **Conclusions and future questions**: Summarize your conclusions and discuss any questions you might interested in exploring in the future. Are there other types of datasets that would have been helpful to have? 
...
## Part Four: Reflection and Self-evaluation (5 points), due 12/6
